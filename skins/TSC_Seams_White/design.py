"""Stealth bomber in white: flat chalk white, glossy white panel lines along the main seams."""
...
def design(s):
    s.paint("body", "matte", colour="#d9dbd9")
    s.paint("body", "gloss", colour="#dcdedc", zone=shapes.seams(1.5, parts=MAIN))
