...
coloured by where each line runs, cyan along the top, magenta over the shoulders, yellow low on
the sides (the user: "I meant is in the whole cyan magenta yellow").
...
def design(s):
    _unravelled.design(s, look="rise")
